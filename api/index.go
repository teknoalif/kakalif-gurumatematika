...
func dashboardHTML() string {
    ...
    <style>
        ...
        /* FIX UNTUK VIDEO */
        .video-wrapper{position:relative; width:100%; padding-top:56.25%; height:0; background:#000; border-radius:12px; overflow:hidden;}
        ...
        <div class="main-wrapper">
            ...
            <div class="card">
                ...
                <div class="video-wrapper">
                    <iframe src="https://www.youtube.com/embed/_3pqgVhtDBg" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </body></html>`
