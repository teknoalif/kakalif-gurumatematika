...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* Ganti CSS video di dalam <style> dengan ini: */
.video-container { 
    width: 100%; 
    border-radius: 12px; 
    overflow: hidden; 
...
func renderBuku() string {
	return `<!DOCTYPE html><html lang="id"><body style="font-family:system-ui, sans-serif; max-width:700px; margin:auto; padding:40px 20px;">
        ...
        <div style="border:2px solid #E2E8F0; border-radius:12px; overflow:hidden; margin-bottom:20px; aspect-ratio: 16/9;">
            <iframe src="https://drive.google.com/file/d/17SbICWWxQOCRf_l4xOVrjAU20CBNkY0X/preview" width="100%" height="100%" style="border:none;"></iframe>
        </div>
